...
The missing feature is support for generalized existentials. There has been extensive discussion of this — there’s even a [manifesto](/siesta/guide/https:/github.com/apple/swift/blob/master/docs/GenericsManifesto#generalized-existentials)! — but the problem has proved large and has been repeatedly deferred. That means we won’t be getting `Resource<T>` until some far future version of Swift.
